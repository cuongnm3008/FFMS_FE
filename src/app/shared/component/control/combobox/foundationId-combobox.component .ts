...
@Component({
  selector: 'foundationId-combobox',
  template: `
        <nz-select
            [(ngModel)]="sModel"
            nzAllowClear
...
export class FoundationIdComboBoxComponent extends ComboBoxBaseComponent implements OnInit {
...
export class FoundationIdComboBoxModule { }
